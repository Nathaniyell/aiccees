...
export default function RegistrationPage() {
  ...
  const committeeFormUrl =
    "https://docs.google.com/forms/d/e/1FAIpQLSdALK5icHkA80ZF1csRJpExyUgMwdIBTLkqNgSQumhb90nO5w/viewform";
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
              Choose the appropriate application form based on your needs. Each
              form is designed to collect specific information for different
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="hover:shadow-lg transition-all duration-300 border-2 hover:border-green-300 dark:hover:border-green-600">
              ...
              <CardContent className="text-center">
                ...
                >
                  <a href="#registration-form">View Registration Form</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-all duration-300 border-2 hover:border-blue-300 dark:hover:border-blue-600">
              ...
              <CardContent className="text-center">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-6">
                  Apply for visa support and travel assistance. This form is for
                  international participants who need assistance with visa
            ...
            <Card className="hover:shadow-lg transition-all duration-300 border-2 hover:border-purple-300 dark:hover:border-purple-600">
              ...
              <CardContent className="text-center">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-6">
                  Join our scientific committee and contribute to the conference
                  organization. Help review papers, moderate sessions, and shape
