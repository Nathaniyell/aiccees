...
const WhatsappLive = () => {
    ...
    return (
        <div>
            ...
            >
                <span className='absolute left-0 top-0 size-16 -z-50 animate-pulse'>
                    <span className='flex size-full items-center justify-center bg-green-500 rounded-full opacity-75 shadow-lg'>
                        <Image
                            src={whatsappIcon}
                            alt="Whatsapp"
                            className="z-50 size-14 rounded-full p-2 hover:scale-110 transition-transform duration-300"
                        />
                    </span>
                </span>
            </a>
