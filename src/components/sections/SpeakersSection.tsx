            ...
            <div className="w-11/12 mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {SPEAKERS.map((speaker) => (
                        <Card key={speaker.name} className="bg-white border-green-200">
                            <CardHeader>
                                <Image
                                    src={speaker.image}
                                    alt={speaker.name}
                                ...
                                />
                                <CardTitle className="text-green-600">{speaker.name}</CardTitle>
                                <CardDescription className="text-red-600 font-semibold">{speaker.role}</CardDescription>
                            </CardHeader>
                            <CardContent className='s3ace-y-3'>
                                <p className="text-sm text-gray-600">{speaker.bio}</p>
                                {/* {speaker.bio2 && <p className="text-sm text-gray-600">{speaker.bio2}</p>} */}
                            </CardContent>
                        </Card>
                    ))}
                </div>
