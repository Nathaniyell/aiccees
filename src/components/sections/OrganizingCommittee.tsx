  ...
  return (
    <div className="h-[150vh]">
      ...
      <div className="container mx-auto">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">Committee Members</h3>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-gray-900 mb-1 truncate">{member.name}</h4>
